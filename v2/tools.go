...
// to all the methods with receiver *Tools
type Tools struct {
	MaxFileSize        int
...
// RandomString returns a string of random characters of length n using random string source as the source
// for the string
...
// PushJSONToRemote posts arbitrary data to some URL as JSON, and returns the response
